          ...
          <!-- / .main-navbar -->
             <!-- / Normal Outline Buttons -->
                    ...
                    <li class="list-group-item p-3">
                          ...
                          <form action="<?php echo URLROOT; ?>/rides/editRide" method="post">
                            <input hidden type="text" name="id_ride" value="<?php echo $data['rides'][0]->id; ?>" >
                            <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" value="<?php echo $data['rides'][0]->nombre_place; ?>" name="nombre_place" min="1" max="3" class="form-control" required placeholder="Places" aria-label="Username" aria-describedby="basic-addon1">
                                <span class="invalid-feedback"><?php echo $data['nombre_place_err']; ?></span>
                                 
                            </div>
                            <div class="form-group col-md-4">
                              <strong class="text-muted d-block mb-2">Date:</strong>
                              <input value="<?php echo $data['rides'][0]->date_depart; ?>" type="date" required name="date_depart" class="form-control" id="inputPassword4"  > </div>
                                  <div class="form-group col-md-4">
                              <strong class="text-muted d-block mb-2">Departure time:</strong>
                              <input value="<?php echo $data['rides'][0]->heure_depart; ?>" type="time" required name="heure_depart" class="form-control" id="inputPassword4"  > </div>
                            </div>
                            <div class="row">
                               <div class="form-group col-md-4">
                              <strong class="text-muted d-block mb-2">Price DT:</strong>
                              <input type="number" value="<?php echo $data['rides'][0]->prix; ?>" required name="prix" class="form-control" id="inputPassword4"  > </div>
                               <div class="form-group col-md-4">
                              <strong class="text-muted d-block mb-2">From:</strong>
                              
                                <select required name="cite_depart"  id="inputState" class="form-control">>
                                  <option ><?php echo $data['rides'][0]->cite_depart; ?></option>
                              ...
                              <select required name="destination"  id="inputState" class="form-control">>
                                  <option ><?php echo $data['rides'][0]->destination; ?></option>
                                  <option>Ariana</option>
                                  <option>Béja</option>
                                  <option>Ben Arous</option>
                                  <option>Bizerte</option>
                              ...
                              <input required type="text" value="<?php echo $data['rides'][0]->point_rassemblement;?>"  name="point_rassemblement" class="form-control" id="inputPassword4"  > </div>
                              <div class="form-group col-md-4">
                              <strong class="text-muted d-block mb-2">intermediate point1:</strong>
                              <input value="<?php echo $data['rides'][0]->point_intermediaire1;?>" type="text" required name="point_intermediaire1" class="form-control" id="inputPassword4"  > </div>
                              <div class="form-group col-md-4">
                              <strong class="text-muted d-block mb-2">intermediate point2:</strong>
                              <input value="<?php echo $data['rides'][0]->point_intermediaire2;?>" required type="text" name="point_intermediaire2" class="form-control" id="inputPassword4"  > </div>
                              </div>
                              <div class="row">
                              <div class="form-group col-md-3">
                              <strong class="text-muted d-block mb-2">Car Model:</strong>
                              <input required type="text" value="<?php echo $data['rides'][0]->modele_voiture;?>" name="modele_voiture" class="form-control" id="inputPassword4"  > </div>
                              <div class="form-group col-md-3">
                              <strong class="text-muted d-block mb-2">Car Color:</strong>
                              <input value="<?php echo $data['rides'][0]->couleur_voiture;?>" required type="text" name="couleur_voiture" class="form-control" id="inputPassword4"  > </div>

                              <div class="form-group col-md-3">
                              <strong class="text-muted d-block mb-2">Stuff:</strong>
                              <select name="bagage"  id="inputState" class="form-control">
                                 <option selected> <?php echo $data['rides'][0]->bagage;?></option>
                              ...
                              <select name="animaux" id="inputState" class="form-control">
                                  <option selected> <?php echo $data['rides'][0]->animaux;?></option>
                                  <option>Not allowed</option>
                                  <option >Allowed</option>
                              ...
                              <input  type="submit" value="EDIT" class="mb-2 btn btn-success mr-2" style="width: 117px;font-size: 24px;">
