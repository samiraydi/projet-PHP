    ...
    <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
      ...
      <div class="nav-wrapper">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo URLROOT; ?>/Rides/active">
              <i class="material-icons active">directions_car</i>
              <span>ACTIVE RIDES</h1></span>
            </a>
          </li>
          <li class="nav-item">
...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      <span class="text-uppercase page-subtitle">ACTIVE RIDES</span>
      <h3 class="page-title">YOUR NEXT RIDES</h3>
    </div>
  </div>
  <!-- End Page Header -->
  <!-- Default Light Table -->
  ...
  <div>
    <h4 class="page-title">AS DRIVER:</h4>
  </div>
  <div class="error__content">
    <?php if (!$data['rides']) echo "<h3> NOT FOUND</h3>"; ?>
  </div>
  <!-- ssssssssssss -->
        ...
        <div class="col-md-6">
          ...
          <div class="card-body">
            ...
            <span id="dots<?php echo $a; ?>"></span><span style="display: none;" id="more<?php echo $a; ?>">
              ...
              <div>
                <form action="<?php echo URLROOT; ?>/rides/edit" method="post">
                  <input type="text" name="RideId" hidden value="<?php echo $ride->rideid; ?>">
                  <input style="margin-left: -13px;" type="submit" class="mb-2 btn btn-sm btn-outline-info mr-1" value="EDIT" onClick="window.location.href='<?php echo URLROOT; ?>/rides/edit'">
                  </form>
                  <form action="<?php echo URLROOT; ?>/rides/deleteRide" method="post">
                  <input type="text" name="RideId" hidden value="<?php echo $ride->conducteur; ?>">
                  <input type="text" name="RideId" hidden value="<?php echo $ride->rideid; ?>">
                <input type="submit" class="mb-2 btn btn-sm btn-outline-danger mr-1" value="DELETE" onclick="if(confirm('Are You Sur To Delete?')) window.location.href='<?php echo URLROOT; ?>/rides/deleteRide'" style="
    margin-left: 50px;
    margin-top: -54px;
">
                </form>
...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
      ...
      <h3 class="page-title">AS PASSENGER</h3>
    </div>
  </div>

  <div class="error__content">
    <?php if (!$data['ridesP']) echo "<h3> NOT FOUND</h3>"; ?>
  </div>


  <?php foreach ($data['ridesP'] as $ride) : ?>
    <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <span id="dots<?php echo $a; ?>"></span><span style="display: none;" id="more<?php echo $a; ?>">
              ...
              <div>
                ...
                <form action="<?php echo URLROOT; ?>/reservations/delete" method="post">
                    <input type="text" name="RideId" hidden value="<?php echo $ride->rideid; ?>">
                <input type="submit" class="mb-2 btn btn-sm btn-outline-danger mr-1" value="DELETE" onclick="if(confirm('Are You Sur To Delete??')) window.location.href='<?php echo URLROOT; ?>/reservations/delete'">
                </form>
