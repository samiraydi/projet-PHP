  ...
  <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo URLROOT ;?>/Users/feedback">
...
<!-- Page Header -->
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">SEND YOUR FEEDBACK</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <div class="row">
              <div class="col-lg-12 col-md-12">
                ...
                <div class="card card-small mb-3">
                  <div class="card-body">
                    <form class="add-new-post" action="<?php echo URLROOT; ?>/users/feedback" method="post">
                      <label for="feDescription">SUBJECT</label>
                      <input class="form-control form-control-lg mb-3" name="subject" type="text" placeholder="Title">
    ...
    margin-top: 15px;
">
<input  type="submit" value="SEND" class="mb-2 btn btn-success mr-2"  style="
    font-size: 19px;
">
